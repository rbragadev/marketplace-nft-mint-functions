 ...
 <div className="container">
    <div className="row align-items-center">
          <div className="col-md-6">
              ...
              <h6 className=""><span className="text-uppercase color">MarketPlace NFT</span></h6>
              </Reveal>
              ...
              <p className=" lead">
              NFT Market Project, with smart contract integration and generation of NFTs in a simplified way by the user. developed by Raphael Braga.
              </p>
              </Reveal>
              <div className="spacer-10"></div>
